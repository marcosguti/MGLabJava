        ...
        <script>
            $(document).ready(function () {
                $('.botonMenuPacientes').mouseenter(function () {
                    $('#listSubMenuPacientes').css('display', 'block');
                });
                $('.menuPacientes').mouseleave(function () {
                    $('#listSubMenuPacientes').css('display', 'none');
                });
                $('.botonMenuResultados').mouseenter(function () {
                    $('#listSubMenuResultados').css('display', 'block');
                });
                $('.menuResultados').mouseleave(function () {
                    $('#listSubMenuResultados').css('display', 'none');
                });
                $('.botonMenuPruebas').mouseenter(function () {
                    $('#listSubMenuPruebas').css('display', 'block');
                });
                $('.menuPruebas').mouseleave(function () {
                    $('#listSubMenuPruebas').css('display', 'none');
                });

                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="forms"><i class="fa fa-plus fa-fw "></i>  Registrar</a>
                                    </li>
                                    <li>
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="registro" method="POST" id="register-form" novalidate="novalidate">
...
<script src="<c:url value='http://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/jquery.validate.min.js' />"></script>
